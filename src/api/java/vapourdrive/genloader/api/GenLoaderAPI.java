...
public class GenLoaderAPI
{
	 ...
	 */
	public static void addGeneration(GenerationCategory category, EnumGenerationPriority genPriority, EnumGenerationType genType, int frequency, int minY, int maxY, int size,
	 ...
	 * @param weightedBlockStates an array of weighted blocks, determines the blocks weight for it's occurrence in the generation
	 */
	public static void addGeneration(GenerationCategory category, EnumGenerationType genType, int frequency, int minY, int maxY, int size, WeightedBlockState[] weightedBlockStates)
	{
