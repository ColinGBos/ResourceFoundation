...
public class GenLoaderAPI
{
	...
	{
		generators.add(new Generation(category, EnumGenerationPriority.LATE, genType, frequency, minY, maxY, size, new ArrayList<Integer>(Arrays.asList(new Integer[]{0})), null, null, weightedBlockStates, new ParsableBlockState(Blocks.stone.getDefaultState())));
	}
